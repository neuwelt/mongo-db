...
await db.collection("Angebot").insertMany([
  ...
  { AngNr: 1, KursNr: "G10", Datum: new Date("2023-12-01"), Ort: "Augsburg" },
  { AngNr: 2, KursNr: "G10", Datum: new Date("2023-02-15"), Ort: "Muenchen" },
  { AngNr: 1, KursNr: "P13", Datum: new Date("2023-05-28"), Ort: "Augsburg" },
  { AngNr: 2, KursNr: "P13", Datum: new Date("2023-07-01"), Ort: "Augsburg" },
  { AngNr: 1, KursNr: "I09", Datum: new Date("2023-03-27"), Ort: "Mindelheim" },
  { AngNr: 2, KursNr: "I09", Datum: new Date("2023-04-23"), Ort: "Muenchen" },
